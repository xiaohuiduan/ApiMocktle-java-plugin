...
import com.apimocktle.util.RegexUtils
import com.apimocktle.util.RuleToolUtils
...
class ScriptHelper(private val context: RuleContext) {
    ...
    private val linkResolver: com.apimocktle.psi.LinkResolver? by lazy {
        com.apimocktle.psi.LinkResolver.getInstance(context.project)
    }
