package com.apimocktle.rule.engine
...
import com.apimocktle.rule.RuleProvider
import com.apimocktle.rule.RuleResult
import com.apimocktle.rule.context.RuleContext
import com.apimocktle.rule.parser.*
import com.apimocktle.util.asBooleanOrNull
import com.apimocktle.util.asInt
...
class RuleEngine internal constructor(
    ...
    suspend fun evaluate(
        key: RuleKey.StringKey,
        resolvedType: com.apimocktle.psi.type.ResolvedType,
        contextElement: PsiElement? = null
    ): String? {
    ...
    suspend fun evaluate(key: RuleKey.StringKey, method: com.apimocktle.psi.type.ResolvedMethod, fieldContext: String? = null): String? {
        return forEachApplicable(key) { RuleContext.from(project, method, fieldContext) }
    }

    suspend fun evaluate(key: RuleKey.StringKey, field: com.apimocktle.psi.type.ResolvedField, fieldContext: String? = null): String? {
        return forEachApplicable(key) { RuleContext.from(project, field, fieldContext) }
    }

    suspend fun evaluate(key: RuleKey.BooleanKey, method: com.apimocktle.psi.type.ResolvedMethod, fieldContext: String? = null): Boolean {
        return forEachApplicable(key) { RuleContext.from(project, method, fieldContext) } ?: false
    }

    suspend fun evaluate(key: RuleKey.BooleanKey, field: com.apimocktle.psi.type.ResolvedField, fieldContext: String? = null): Boolean {
        return forEachApplicable(key) { RuleContext.from(project, field, fieldContext) } ?: false
    }

    suspend fun evaluate(key: RuleKey.EventKey, method: com.apimocktle.psi.type.ResolvedMethod, fieldContext: String? = null) {
        forEachApplicable(key) { RuleContext.from(project, method, fieldContext) }
    }

    suspend fun evaluate(key: RuleKey.EventKey, field: com.apimocktle.psi.type.ResolvedField, fieldContext: String? = null) {
        forEachApplicable(key) { RuleContext.from(project, field, fieldContext) }
    }

    suspend fun evaluate(key: RuleKey.EventKey, method: com.apimocktle.psi.type.ResolvedMethod, contextHandle: (RuleContext) -> Unit) {
        forEachApplicable(key) {
