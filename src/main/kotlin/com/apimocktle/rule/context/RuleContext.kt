...
import com.apimocktle.logging.IdeaConsole
import com.apimocktle.logging.IdeaLog
import com.apimocktle.logging.IdeaConsoleProvider
import com.apimocktle.psi.helper.AnnotationHelper
...
import com.apimocktle.psi.type.ResolvedField
import com.apimocktle.psi.type.ResolvedMethod
import com.apimocktle.psi.type.ResolvedParam
import com.apimocktle.psi.type.ResolvedType
import com.apimocktle.util.file.FileSaveHelper
import com.apimocktle.util.file.FileSelectHelper
import com.apimocktle.util.storage.LocalStorage
 ...
 * (e.g., `reactor.core.publisher.Mono<com.apimocktle.model.UserInfo>`) for regex matching.
...
class RuleContext private constructor(
     ...
     * - For PsiClass → qualified name (e.g., `com.apimocktle.UserCtrl`)
     * - For PsiMethod → `class#method` (e.g., `com.apimocktle.UserCtrl#greeting`)
     * - For PsiField → `class#field` (e.g., `com.apimocktle.UserInfo#name`)
     * - For PsiParameter → `class#method.param` (e.g., `com.apimocktle.UserCtrl#greeting.id`)
     */
