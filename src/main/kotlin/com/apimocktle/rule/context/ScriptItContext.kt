...
import com.apimocktle.psi.helper.BlockingAnnotationHelper
import com.apimocktle.psi.helper.BlockingDocHelper
...
open class ScriptItContext(protected val context: RuleContext) {
     ...
     *
     * - class → qualified name (e.g., `com.apimocktle.UserCtrl`)
     * - method → `class#method` (e.g., `com.apimocktle.UserCtrl#greeting`)
     * - field → `class#field` (e.g., `com.apimocktle.UserInfo#name`)
     * - param → `class#method.param` (e.g., `com.apimocktle.UserCtrl#greeting.id`)
