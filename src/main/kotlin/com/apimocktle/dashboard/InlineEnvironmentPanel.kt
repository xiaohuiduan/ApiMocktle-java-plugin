...
class InlineEnvironmentPanel(private val project: Project) : JPanel(BorderLayout()) {
    ...
    private val scopeCombo = JComboBox(arrayOf("项目", "全局"))

    private val varTableModel = object : DefaultTableModel(arrayOf("键", "值"), 0) {
    ...
    private val saveButton = JButton("保存").apply {
        toolTipText = "保存对当前环境的更改"
        isEnabled = false
    }
    private val settingsLink = JButton("设置...").apply {
        toolTipText = "打开完整环境设置"
