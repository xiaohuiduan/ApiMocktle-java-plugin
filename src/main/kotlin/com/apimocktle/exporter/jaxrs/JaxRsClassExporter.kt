...
class JaxRsClassExporter(
    ...
    private suspend fun exportMethod(
        ...
        resolvedMethod: com.apimocktle.psi.type.ResolvedMethod
    ): List<ApiEndpoint> {
    ...
    private suspend fun extractParamHeaders(resolvedMethod: com.apimocktle.psi.type.ResolvedMethod): List<ApiHeader> {
    ...
    private suspend fun buildParameters(resolvedMethod: com.apimocktle.psi.type.ResolvedMethod): List<ApiParameter> {
