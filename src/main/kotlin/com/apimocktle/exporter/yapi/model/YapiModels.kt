package com.apimocktle.exporter.yapi.model
...
/**
 * Represents a YAPI project the user has access to.
 *
 * @property id The project ID
 * @property name The project name
 * @property desc The project description
 */
data class YapiProjectInfo(
    val id: String,
    val name: String,
    val desc: String = ""
)
 ...
 */
data class YapiCart(val id: String, val name: String)
