...
import com.apimocktle.psi.model.ObjectModelUtils
import com.apimocktle.psi.type.PrimitiveKind
 ...
 *
 * Centralizes common logic that was previously duplicated in SpringMVC, Feign,
 * and other exporters, including:
...
class EndpointBuilder(private val project: Project) {
     ...
     *
     * Allows framework-specific model construction (e.g., standard SpringMVC/Feign
     * use [PsiClassHelper]).
     */
    ...
    fun mergePathParameters(
        ...
        for (param in methodParams) {
            if (param.binding == com.apimocktle.exporter.model.ParameterBinding.Path) {
    ...
    companion object : com.apimocktle.logging.IdeaLog {
        /**
