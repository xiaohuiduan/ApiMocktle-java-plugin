...
class NestedFieldParsingTest : ApiMocktleLightCodeInsightFixtureTestCase() {
    ...
    fun testValueConverterHandlesCircularObjectModel() {
        ...
        val fields = linkedMapOf<String, com.apimocktle.psi.model.FieldModel>()
        val obj = ObjectModel.Object(fields)
        // Add a field that references the same object (simulating circular reference from cache)
        fields["self"] = com.apimocktle.psi.model.FieldModel(model = obj)
        fields["name"] = com.apimocktle.psi.model.FieldModel(
            model = ObjectModel.single(com.apimocktle.psi.type.JsonType.STRING)
        )
