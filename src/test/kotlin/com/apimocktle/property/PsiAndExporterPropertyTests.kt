package com.apimocktle.property
...
import com.apimocktle.exporter.springmvc.SpringParameterBindingResolver
import com.apimocktle.psi.helper.UnifiedAnnotationHelper
import com.apimocktle.psi.type.GenericContext
...
class PsiAndExporterPropertyTests : ApiMocktleLightCodeInsightFixtureTestCase() {
    ...
    fun testSpringMvcParameterBindingResolution() = runBlocking {
        ...
        assertEquals(com.apimocktle.exporter.model.ParameterBinding.Body, bindings["body"])
        assertEquals(com.apimocktle.exporter.model.ParameterBinding.Query, bindings["q"])
        assertEquals(com.apimocktle.exporter.model.ParameterBinding.Path, bindings["p"])
        assertEquals(com.apimocktle.exporter.model.ParameterBinding.Header, bindings["h"])
        assertEquals(com.apimocktle.exporter.model.ParameterBinding.Cookie, bindings["c"])
        assertEquals(
            com.apimocktle.exporter.model.ParameterBinding.Ignored,
    ...
    fun testAnnotationDrivenFieldNameOverride() = runBlocking {
        ...
        project.registerServiceInstance(
            serviceInterface = com.apimocktle.config.ConfigReader::class.java,
