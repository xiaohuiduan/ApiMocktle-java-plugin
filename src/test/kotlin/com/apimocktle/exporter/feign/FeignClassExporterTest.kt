...
class FeignClassExporterTest : ApiMocktleLightCodeInsightFixtureTestCase() {
    ...
    fun testExportWithPathVariable() = runTest {
        ...
        assertTrue(getEndpoint!!.httpMetadata!!.parameters.any { it.binding == com.apimocktle.exporter.model.ParameterBinding.Path })
    }
