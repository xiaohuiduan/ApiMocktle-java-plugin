...
class ActuatorEndpointScannerTest : ApiMocktleLightCodeInsightFixtureTestCase() {
    ...
    fun testExportStandard() = runTest {
        ...
        endpoints[0].let { endpoint ->
            ...
            val pathParams = endpoint.httpMetadata?.parameters?.filter { it.binding == com.apimocktle.exporter.model.ParameterBinding.Path } ?: emptyList()
        ...
        endpoints[1].let { endpoint ->
            ...
            assertEquals(1, endpoint.httpMetadata?.parameters?.filter { it.binding == com.apimocktle.exporter.model.ParameterBinding.Path }?.size)
    ...
    fun testExportWeb() = runTest {
        ...
        endpoints[0].let { endpoint ->
            ...
            assertEquals(2, endpoint.httpMetadata?.parameters?.filter { it.binding == com.apimocktle.exporter.model.ParameterBinding.Path }?.size)
        }
