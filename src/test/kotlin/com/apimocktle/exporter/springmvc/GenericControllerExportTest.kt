...
class GenericControllerExportTest : ApiMocktleLightCodeInsightFixtureTestCase() {
    ...
    fun testCase1_InheritedMethodsExported() = runTest {
        ...
        val getItem = endpoints.find { it.path == "/string/item" && it.httpMetadata?.method == com.apimocktle.exporter.model.HttpMethod.GET }
        assertNotNull("Should export GET /string/item", getItem)

        val postItem = endpoints.find { it.path == "/string/item" && it.httpMetadata?.method == com.apimocktle.exporter.model.HttpMethod.POST }
