...
class SpringMvcClassExporterTest : ApiMocktleLightCodeInsightFixtureTestCase() {
    ...
    fun testExportWithGetMapping() = runTest {
        ...
        val endpoints = exporter.export(psiClass!!)
        val getEndpoints = endpoints.filter { it.httpMetadata?.method == com.apimocktle.exporter.model.HttpMethod.GET }
    ...
    fun testExportWithPostMapping() = runTest {
        ...
        val endpoints = exporter.export(psiClass!!)
        val postEndpoints = endpoints.filter { it.httpMetadata?.method == com.apimocktle.exporter.model.HttpMethod.POST }
    ...
    fun testRequestMappingWithRequestBodyDefaultsToPost() = runTest {
        ...
        assertEquals(com.apimocktle.exporter.model.HttpMethod.POST, updateWithBody!!.httpMetadata?.method)
    }
    ...
    fun testRequestMappingWithoutBodyDefaultsToGet() = runTest {
        ...
        assertEquals(com.apimocktle.exporter.model.HttpMethod.GET, simple!!.httpMetadata?.method)
    }
    ...
    fun testExplicitGetWithBodyRemainsGet() = runTest {
        ...
        assertEquals(com.apimocktle.exporter.model.HttpMethod.GET, explicitGet!!.httpMetadata?.method)
    }
    ...
    fun testRequestMappingWithModelAttributeDefaultsToPost() = runTest {
        ...
        assertEquals(com.apimocktle.exporter.model.HttpMethod.POST, updateWithModel!!.httpMetadata?.method)
    }
    ...
    fun testResponseBodyIsPopulated() = runTest {
        ...
        assertTrue("responseBody should be an Object model", responseObj is com.apimocktle.psi.model.ObjectModel.Object)
        val fields = (responseObj as com.apimocktle.psi.model.ObjectModel.Object).fields
    ...
    fun testRequestBodyIsPopulated() = runTest {
        ...
        assertTrue("body should be an Object model", bodyObj is com.apimocktle.psi.model.ObjectModel.Object)
        val fields = (bodyObj as com.apimocktle.psi.model.ObjectModel.Object).fields
    ...
    fun testFieldCommentsArePopulated() = runTest {
        ...
        val bodyObj = createEndpoint.httpMetadata?.body as? com.apimocktle.psi.model.ObjectModel.Object
    ...
    fun testResponseBodyGenericTypeResolution() = runTest {
        ...
        val responseObj = createEndpoint.httpMetadata?.responseBody as? com.apimocktle.psi.model.ObjectModel.Object
        ...
        assertTrue(
            ...
            dataModel is com.apimocktle.psi.model.ObjectModel.Object
        )

        val userInfoFields = (dataModel as com.apimocktle.psi.model.ObjectModel.Object).fields
    ...
    fun testReturnDocOnGenericField() = runTest {
        ...
        val responseObj = endpoint.httpMetadata?.responseBody as? com.apimocktle.psi.model.ObjectModel.Object
        assertNotNull(responseObj)
    ...
    fun testMultipartFileFieldExportedAsFileParam() = runTest {
        ...
        assertEquals(
            ...
            com.apimocktle.exporter.model.ParameterType.FILE,
            profileImgParam!!.type
        )
        assertEquals(
            "profileImg should have Form binding",
            com.apimocktle.exporter.model.ParameterBinding.Form,
