...
class YapiExporterTest : ApiMocktleLightCodeInsightFixtureTestCase() {
    ...
    ): com.apimocktle.exporter.model.ApiEndpoint {
        return com.apimocktle.exporter.model.ApiEndpoint(
            name = name,
    ...
    private fun createTestContext(
        endpoints: List<com.apimocktle.exporter.model.ApiEndpoint>,
        outputConfig: OutputConfig = OutputConfig()
    ): com.apimocktle.exporter.model.ExportContext {
        return com.apimocktle.exporter.model.ExportContext(
            project = exporterProject,
            endpoints = endpoints,
            exportFormat = ExportFormat.YAPI,
            settings = com.apimocktle.settings.Settings(),
