...
class GrpcMethodResolverTest : ApiMocktleLightCodeInsightFixtureTestCase() {
    ...
    fun testResolveFromRpcMethodAnnotation() = runTest {
        val psiClass = findClass("com.apimocktle.grpc.test.EchoServiceGrpc")
    ...
    fun testExtractTypesFromAnnotation() = runTest {
        ...
        assertNotNull("Response type should be resolved", echoMethod.responseType)
        assertEquals("Request type should be EchoRequest", 
            "com.apimocktle.grpc.test.EchoRequest", echoMethod.requestType!!.qualifiedName)
        assertEquals("Response type should be EchoResponse", 
            "com.apimocktle.grpc.test.EchoResponse", echoMethod.responseType!!.qualifiedName)
    }
